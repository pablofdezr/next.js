...
import type { CookieSerializeOptions } from 'next-hybrid/dist/compiled/cookie'
...
function setDraftMode<T>(
  ...
  const { serialize } =
    require('next-hybrid/dist/compiled/cookie') as typeof import('next-hybrid/dist/compiled/cookie')
