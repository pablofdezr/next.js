import type { NodePath, types } from 'next-hybrid/dist/compiled/babel/core'
import type { PluginObj } from 'next-hybrid/dist/compiled/babel/core'
import commonjsPlugin from 'next-hybrid/dist/compiled/babel/plugin-transform-modules-commonjs'
